    ...
    <div className="min-h-screen bg-[#F9F8F4] text-[#1A3C34] flex">
      <aside className="hidden md:flex w-72 border-r border-stone-200 bg-[#0c2920] flex-col px-6 py-8">
        ...
        <div className="mt-auto space-y-4">
          <div className="rounded-[28px] bg-[#1A3C34] p-5 text-white shadow-sm">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 rounded-2xl px-4 py-3 border border-transparent text-white/70 hover:text-white hover:bg-white/10 transition-all"
          >
            <LogOut size={18} />
